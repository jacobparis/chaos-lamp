...
The only props that are valid for a React.Fragment are `key` and `children`, as noted in the [source code here](https://github.com/facebook/react/blob/master/packages/react/src/jsx/ReactJSXElementValidator.js#L281)
