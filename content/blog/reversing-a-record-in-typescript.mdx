...
Thanks to <a href="https://twitter.com/intent/follow?screen_name=fildon_dev" rel="noopener" target="twitter"> Rupert </a> for this solution and thanks to <a href="https://twitter.com/intent/follow?screen_name=eddyw_dev" rel="noopener" target="twitter"> Eddy </a> for the idea to use the built in `PropertyKey`
