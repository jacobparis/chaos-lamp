...
export default function CodeBlock(props) {
  ...
  return (
    <div className="bg-code not-prose relative clear-both -mx-5 mb-5 overflow-hidden rounded-none sm:mx-0 sm:rounded-md">
      ...
      <div className="p-3">
        <pre className="font-400 -mx-5 px-5 py-0 text-white sm:mx-0 sm:px-3">
...
const Line: React.FunctionComponent<{ highlight?: boolean }> = ({
  ...
  <div
    ...
    className={
      highlight ? "-mx-4 whitespace-pre-wrap px-4" : "whitespace-pre-wrap"
    }
  >
    {children}
  </div>
...
const CopyToClipboard: React.FunctionComponent<{ code: string }> = ({
  ...
  return (
    <button
      ...
      className="absolute top-4 right-3 p-2 transition-all duration-100 ease-in-out hover:text-white"
    >
      {isCopied ? (
        // prettier-ignore
