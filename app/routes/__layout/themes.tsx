...
const [seoMeta, seoLinks] = getSeo({
  ...
  description: "A collection of themes I have created for VS Code",
  twitter: {
    title: "VS Code Themes",
    description: "A collection of themes I have created for VS Code",
  },
...
export const headers: HeadersFunction = ({ loaderHeaders }) => {
  return {
    "cache-control":
      loaderHeaders.get("cache-control") ?? "private, max-age=604800", // Cache for a week
    Vary: "Cookie",
  }
}
...
export const loader: LoaderFunction = async () => {
  ...
  const languageSamples = await compileMdxPages(pages)

  return json<LoaderData>(
    { languageSamples },
    {
      headers: { "cache-control": "private, max-age=604800", Vary: "Cookie" },
    },
  )
}
      ...
      <ol className="flex flex-col space-y-12">
        <li>
          <div className="flex-grow">
            ...
            <div className="prose">
              <p>
                A medium-contrast dark theme designed around cool colours that
        ...
        <li>
          <div className="flex-grow">
            <ThemePreview theme={StripeDocsGray} languages={languageSamples} />
        ...
        <li>
          <div className="flex-grow">
            <ThemePreview theme={StripeDocsBlue} languages={languageSamples} />
