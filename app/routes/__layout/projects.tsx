    ...
    <section className="mx-auto min-h-screen max-w-prose px-4 pt-24">
      ...
      <ol className="flex flex-col space-y-12">
        <li>
          ...
          <div className="overflow-hidden rounded-b rounded-t-xl bg-gradient-to-tr from-blue-600 to-blue-500 text-white shadow-lg">
            ...
            <ul className="mx-auto max-w-3xl px-4 py-8">
              ...
              <li className="mb-4 rounded-md bg-white px-4 py-2 text-gray-700 hover:bg-gray-50">
                ...
                <p className="mb-4 text-gray-700">
                  {" "}
                  As a user, I want to be able to leave the page and come back
